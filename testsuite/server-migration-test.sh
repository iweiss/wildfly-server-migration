...
TARGET_DIST_CMTOOL_MODULES_DIR=$TARGET_DIST_DIR/modules/system/layers/base/cmtool
...
rm -Rf $SOURCE_DIST_CMTOOL_MODULES_DIR
rm -Rf $TARGET_DIST_CMTOOL_MODULES_DIR
...
cp -Rf $TEST_BEFORE_DIR/modules/cmtool $SOURCE_DIST_CMTOOL_MODULES_DIR
...
$TOOL_DIR/server-migration.sh --source $SOURCE_DIST_DIR --target $TARGET_DIST_DIR --interactive false -Djboss.server.migration.modules.includes="cmtool.module1" -Djboss.server.migration.modules.excludes="cmtool.module2,cmtool.module3"
